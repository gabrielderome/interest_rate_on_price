...
plt.plot(df_taux_hypothecaire_terme_5ans['CalendarMonth'], df_taux_hypothecaire_terme_5ans['taux_hypothecaire_terme_5ans'], label='taux_hypothecaire_terme_5ans', color='cyan')
# plot the data from five_year_benchmark_bond
plt.plot(five_year_benchmark_bond['CalendarMonth'], five_year_benchmark_bond['interest_rate_value'], label='five_year_benchmark_bond', color='yellow')
# plot the data from long_term_benchmark_bond
plt.plot(long_term_benchmark_bond['CalendarMonth'], long_term_benchmark_bond['interest_rate_value'], label='long_term_benchmark_bond', color='magenta')
...
# display the plot
plt.savefig('interest_rates.png', dpi=300, bbox_inches='tight')